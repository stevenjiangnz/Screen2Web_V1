...
@fancy-highlight-bg-color: #0fe4e4;
@fancy-selected-bg-color: darken(@fancy-highlight-bg-color, 10%);
@fancy-highlight-color: black;
@fancy-highlight-border-color: darken(@fancy-highlight-bg-color, 30%);
...
.fancytree-plain  {
	...
	span.fancytree-selected span.fancytree-title { // active/selcted nodes inside inactive tree
		background-color: @fancy-selected-bg-color;
		border-color: @fancy-highlight-border-color;
		color: @fancy-highlight-color;;
	}
	span.fancytree-node span.fancytree-selected span.fancytree-title {
		font-style: italic;
	}
	span.fancytree-node:hover span.fancytree-title {
		background-color: @fancy-highlight-bg-color; // hover is always colored, even if tree is unfocused
		border-color: @fancy-highlight-border-color;
		color: @fancy-highlight-color;;
	}
